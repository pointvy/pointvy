...
def landing():
    ...
    return render_template('main.html', content=content, action=action, version=version)
...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=int(os.environ.get("PORT", 8080)))  # nosec - we are inside a container
